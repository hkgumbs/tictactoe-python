...
class Simulation:
    ...
    def _state_cpu_move(self):
        ...
        if self._board.game_over():
            result.append(m.UTIL['lose_game'] \
                    if self._board.winner() else m.UTIL['tie_game'])
